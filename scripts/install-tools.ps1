...
if ($null -ne $StackwalkExe) {
    ...
    $releaseInfo = Invoke-RestMethod -Uri $apiUrl @ProxyEnv
    ...
    Invoke-WebRequest -Uri $asset.browser_download_url -OutFile $ZipPath -UseBasicParsing @ProxyEnv
...
Write-Host "  带符号分析: .\scripts\analyze.ps1 .\dumps\crash.dmp -ElectronVersion '39.4.0'"
